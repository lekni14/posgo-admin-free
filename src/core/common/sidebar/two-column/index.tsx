                            ...
                            <div className="tab-content" id="v-pills-tabContent">
                                ...
                                <div className="tab-pane fade" id="extras">
                                    <ul>
                                        ...
                                        <li>
                                            <Link href="https://dreamspos.dreamstechnologies.com/documentation/nextjs.html">
                                                <span>Documentation</span>
                                            </Link>
                                        </li>
                                        <li>
                                            <Link href="https://dreamspos.dreamstechnologies.com/documentation/changelog.html">
